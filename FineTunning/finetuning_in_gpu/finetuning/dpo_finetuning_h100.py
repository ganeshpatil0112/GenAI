...
def load_finance_dataset(file_path):
...
def train_h100_dpo_finetuning(
    ...
    """H100 optimized DPO fine-tuning - NO FP16"""
    ...
    dataset = load_finance_dataset(dataset_path)
    ...
    # Train
    print("\n6. Starting H100 optimized DPO training...")
